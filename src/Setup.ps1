...
Invoke-Expression (Join-Path -Path $DotfilesWorkFolder -ChildPath "ChocolateyApps" | Join-Path -ChildPath "Chocolatey_apps.ps1");
...
Invoke-Expression (Join-Path -Path $DotfilesWorkFolder -ChildPath "ACT" | Join-Path -ChildPath "ACT.ps1");
Invoke-Expression (Join-Path -Path $DotfilesWorkFolder -ChildPath "FFLogsUploader" | Join-Path -ChildPath "FFLogsUploader.ps1");
Invoke-Expression (Join-Path -Path $DotfilesWorkFolder -ChildPath "Win10Pcap" | Join-Path -ChildPath "Win10Pcap.ps1");
